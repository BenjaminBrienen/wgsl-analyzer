...
",
        expect![[r#"
            ...
            302..306 '1.0h': f16
            WgslError { expression: Idx::<Expression>(11), message: "invalid function call signature: `determinant(mat3x2<AbstractFloat>)`" } in Body
            WgslError { expression: Idx::<Expression>(14), message: "invalid function call signature: `determinant(mat3x2<f32>)`" } in Body
            WgslError { expression: Idx::<Expression>(17), message: "invalid function call signature: `determinant(mat3x2<f16>)`" } in Body
        "#]],
    );
}

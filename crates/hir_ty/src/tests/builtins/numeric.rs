...
",
        expect![[r#"
            31..45 'abstract_float': mat2x2<f32>
            48..72 'determ...(1.0))': mat2x2<float>
            60..71 'mat2x2(1.0)': mat2x2<float>
            67..70 '1.0': float
            82..90 'float_32': mat2x2<f32>
            93..118 'determ...1.0f))': mat2x2<f32>
            105..117 'mat2x2(1.0f)': mat2x2<f32>
            112..116 '1.0f': f32
            128..136 'float_16': mat2x2<f16>
            139..164 'determ...1.0h))': mat2x2<f16>
            ...
            302..306 '1.0h': f16
            [EditionedFileId(Id(1c00))] WgslError { expression: Idx::<Expression>(11), message: "invalid function call signature: `determinant(mat3x2<AbstractFloat>)`" } in Body
            [EditionedFileId(Id(1c00))] WgslError { expression: Idx::<Expression>(14), message: "invalid function call signature: `determinant(mat3x2<f32>)`" } in Body
            [EditionedFileId(Id(1c00))] WgslError { expression: Idx::<Expression>(17), message: "invalid function call signature: `determinant(mat3x2<f16>)`" } in Body
        "#]],
    );
}

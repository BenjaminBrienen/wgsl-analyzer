...
"#,
        expect![[r#"
            ...
            9863..9878 'MAX_QUBIT_COUNT': unexpected template argument, expected an integer greater than `0`, actual: [error]
            10006..10034 'MAX_WO...ITIONS': unexpected template argument, expected an integer greater than `0`, actual: [error]
            11207..11224 'INSTRU...S_SIZE': unexpected template argument, expected an integer greater than `0`, actual: [error]
            11299..11315 'BLOCK_...E_SIZE': unexpected template argument, expected an integer greater than `0`, actual: [error]
            11378..11397 'FUNCTI...E_SIZE': unexpected template argument, expected an integer greater than `0`, actual: [error]
            11512..11526 'PHI_TABLE_SIZE': unexpected template argument, expected an integer greater than `0`, actual: [error]
            11632..11649 'SWITCH...S_SIZE': unexpected template argument, expected an integer greater than `0`, actual: [error]
            11723..11737 'CALL_ARGS_SIZE': unexpected template argument, expected an integer greater than `0`, actual: [error]
            11832..11850 'CONSTA...A_SIZE': unexpected template argument, expected an integer greater than `0`, actual: [error]
            12850..12863 'MAX_REGISTERS': unexpected template argument, expected an integer greater than `0`, actual: [error]
            12948..12958 'MAX_MEMORY': unexpected template argument, expected an integer greater than `0`, actual: [error]
            14713..14728 'MAX_QUBIT_COUNT': unexpected template argument, expected an integer greater than `0`, actual: [error]
            17289..17306 'NOISE_..._COUNT': unexpected template argument, expected an integer greater than `0`, actual: [error]
            17362..17379 'NOISE_..._COUNT': unexpected template argument, expected an integer greater than `0`, actual: [error]
            17908..17923 'MAX_QUBIT_COUNT': unexpected template argument, expected an integer greater than `0`, actual: [error]
            17946..17961 'MAX_QUBIT_COUNT': unexpected template argument, expected an integer greater than `0`, actual: [error]
            18480..18501 'THREAD...KGROUP': unexpected template argument, expected an integer greater than `0`, actual: [error]
            ...
            19658..19679 'THREAD...KGROUP': unexpected template argument, expected an integer greater than `0`, actual: [error]

 ...
 * up doubling up the indentation. Since there is not any way to tell vscode to
 ...
 * indentation, but that is okay as even without this workaround and the problem
